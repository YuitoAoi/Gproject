...
class TestLlamaFactoryRouter:
    def test_list_models_success(self, client):
        ...
        mock_svc.llamafactory.return_value.list_models.return_value = LlamaFactoryModelsResponse(
            success=True, models=["gpt-3.5-turbo"]
        )
    ...
    def test_chat_success(self, client):
        ...
        mock_svc.llamafactory.return_value.chat.return_value = LlamaFactoryChatResponse(
            success=True, content="Hello!", raw_response={"choices": []}
        )
        resp = tc.post(
            "/llamafactory/chat",
            json={
    ...
    def test_chat_upstream_error(self, client):
        ...
        mock_svc.llamafactory.return_value.chat.return_value = LlamaFactoryChatResponse(error="timeout")
        resp = tc.post(
            "/llamafactory/chat",
            json={
                "model": "gpt-3.5-turbo",
