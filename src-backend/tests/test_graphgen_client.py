...
class TestGraphGenClient:
    ...
    def test_validate_connection(self, client):
        ...
        cl.validate_connection(
            ...
            api_key="sk-xxx", model="test-model",
        )
        mock_http.request.assert_called_with(
            method="POST", url="/api/v1/connections/validate",
            params=None,
    ...
    def test_submit_job(self, client):
        ...
        mock_http.request.assert_called_with(
            ...
            params=None, json=payload, data=None, headers=None, files=None,
        )
    ...
    def test_get_job(self, client):
        ...
        cl.get_job("abc-123")
        mock_http.request.assert_called_with(
            method="GET", url="/api/v1/jobs/abc-123",
            params=None, json=None, data=None, headers=None, files=None,
        )
    ...
    def test_cancel_job(self, client):
        ...
        mock_http.request.assert_called_with(
            method="DELETE", url="/api/v1/jobs/abc-123",
            params=None, json=None, data=None, headers=None, files=None,
        )
