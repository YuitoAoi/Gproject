...
class TestAuthRoutes:
    def test_login_success(self, client):
        ...
        mock_svc.login_user.return_value.execute.return_value = UserLoginResponse(
            success=True, user_id=1, access_token="t"
        )
...
class TestUserRoutes:
    ...
    def test_update_user(self, client):
        ...
        mock_svc.update_user_info.return_value.execute.return_value = UserUpdateResponse(success=True)
    ...
    def test_update_user_error(self, client):
        ...
        mock_svc.update_user_info.return_value.execute.return_value = UserUpdateResponse(
    ...
    def test_register_user(self, client):
        ...
        mock_svc.register_user.return_value.execute.return_value = UserRegisterResponse(success=True, user_id=1)
    ...
    def test_register_failure(self, client):
        ...
        mock_svc.register_user.return_value.execute.return_value = UserRegisterResponse(
            success=False, error="Email already used."
        )
        resp = tc.post("/user", json={"name": "New", "email": "n@b.com", "password": "pw"})
        assert resp.status_code == 409
...
class TestTagRoutes:
    def test_list_tags(self, client):
        ...
        mock_svc.dataset_tag.return_value.get_tags.return_value = DatasetTagsGetResponse(success=True, tags=[])
    ...
    def test_get_tag(self, client):
        ...
        mock_svc.dataset_tag.return_value.get_tag.return_value = DatasetTagInfoGetResponse(
            success=True, tag_id=1, tag_name="red", tag_color="#f00", tag_desc="", tag_created_at=""
        )
    ...
    def test_get_tag_not_found(self, client):
        ...
        mock_svc.dataset_tag.return_value.get_tag.return_value = DatasetTagInfoGetResponse(
            success=False, error="Tag not found", tag_id=0, tag_name="", tag_color="", tag_desc="", tag_created_at=""
        )
    ...
    def test_create_tag(self, client):
        ...
        mock_svc.dataset_tag.return_value.create_tag.return_value = DatasetTagCreateResponse(success=True)
    ...
    def test_create_duplicate(self, client):
        ...
        mock_svc.dataset_tag.return_value.create_tag.return_value = DatasetTagCreateResponse(
    ...
    def test_update_tag(self, client):
        ...
        mock_svc.dataset_tag.return_value.update_tag.return_value = DatasetTagUpdateResponse(success=True)
    ...
    def test_update_not_found(self, client):
        ...
        mock_svc.dataset_tag.return_value.update_tag.return_value = DatasetTagUpdateResponse(
    ...
    def test_delete_tag(self, client):
        ...
        mock_svc.dataset_tag.return_value.delete_tag.return_value = DatasetTagDeleteResponse(success=True)
    ...
    def test_delete_ref_error(self, client):
        ...
        mock_svc.dataset_tag.return_value.delete_tag.return_value = DatasetTagDeleteResponse(
            success=False, error="Tag is referenced by"
        )
        resp = tc.request("DELETE", "/tag", json={"tag_id": 1}, **_auth())
        assert resp.status_code == 400
