    ...
    >
      ...
      >
        <template #suffix>
          ...
          >
            <LfpSvgIcon icon="fluent:arrow-enter-left-20-filled" />
          </div>
        </template>
      </ElInput>
        ...
        <div class="result w-full" v-show="searchResult.length">
          ...
          >
            ...
            >
              ...
              <LfpSvgIcon v-show="isHighlighted(index)" icon="fluent:arrow-enter-left-20-filled" />
            </div>
          </div>
        </div>
        ...
        <div v-show="!searchVal && searchResult.length === 0 && historyResult.length > 0">
          ...
          <div class="mt-1.5 w-full">
            ...
            >
              ...
              >
                <LfpSvgIcon icon="ri:close-large-fill" class="text-xs" />
              </div>
            </div>
          </div>
        </div>
      ...
      <template #footer>
        <div class="dialog-footer box-border flex-c border-t-d pt-4.5 pb-1">
          <div class="flex-cc">
            <LfpSvgIcon icon="fluent:arrow-enter-left-20-filled" class="keyboard" />
            <span class="mr-3.5 text-xs text-g-700">确认</span>
          </div>
          <div class="flex-c">
            <LfpSvgIcon icon="ri:arrow-up-wide-fill" class="keyboard" />
            <LfpSvgIcon icon="ri:arrow-down-wide-fill" class="keyboard" />
...
<script lang="ts" setup>
  ...
  defineOptions({ name: 'LfpGlobalSearch' })
